...
trello_powerups_1.initialize({
    ...
    'attachment-sections': function (t, options) {
        return attachment_service_1.getAttachmentSections(t, options);
    },
...
function getBadges(t) {
    return vote_service_1.getVotesOnCurrentCard(t)
        .then(function (votes) {
        if (votes) {
            var upBadge = createBadge(votes, VotingType_1.VotingType.UP);
            var downBadge = createBadge(votes, VotingType_1.VotingType.DOWN);
...
function getCardButtons(t) {
    return vote_service_1.getVotesOnCurrentCardForCurrentMember(t)
        .then(function (vote) {
        var buttons = [];
        if (vote && vote.votingType === VotingType_1.VotingType.UP) {
            buttons.push(voteDownButton);
            buttons.push(deleteVoteButton);
        }
        else if (vote && vote.votingType === VotingType_1.VotingType.DOWN) {
        ...
        attachment_service_1.attachResults(t);
        return buttons;
    });
}
...
___scope___.file("services/attachment-service.js", function(exports, require, module, __filename, __dirname){
...
function attachResults(t) {
    Promise.all([
        vote_service_1.getVotesOnCurrentCard(t),
        t.card('attachments')
    ]).then(function (_a) {
...
module.exports.default = "894b703d-results.html";
});
___scope___.file("views/settings.html", function(exports, require, module, __filename, __dirname){

module.exports.default = "6b135142-settings.html";
});
});
